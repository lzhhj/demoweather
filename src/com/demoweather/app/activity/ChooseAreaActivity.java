package com.demoweather.app.activity;

import java.util.ArrayList;
import java.util.List;

import com.demoweather.app.R;
import com.demoweather.app.db.WeatherDB;
import com.demoweather.app.model.City;
import com.demoweather.app.model.County;
    ...
    private void queryFromServer(final String code, final String type) {
        ...
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onError(Exception e) {
                Log.e("ChooseAreaActivity", "--->>加载失败", e);
                // 通过runOnUiThread()方法回到主线程处理逻辑
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
